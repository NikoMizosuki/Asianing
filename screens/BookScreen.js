...
const BookScreen = () => {
  ...
  const availableCars = [
    { id: 1, name: 'Car 1', price: 50, isElectric: true },
    { id: 2, name: 'Car 2', price: 40, isElectric: false },
    { id: 3, name: 'Car 3', price: 45, isElectric: true },
  ...
  const filteredCars = greenModeEnabled
    ? availableCars.filter((car) => car.isElectric)
    : availableCars;
